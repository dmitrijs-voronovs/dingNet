...
public class Environment implements Serializable {
    ...
    /**
     * specific to calculations
     */
    private LocalTime simClock;
    /**
    ...
    public void simTick(long period) {
        this.simClock= this.simClock.plus(period, ChronoUnit.MILLIS);
    }
